            ...
            <div class="single-pricing text-center mb-30">
              ...
              <div class="pricing-plan-price <?= $item['PROPERTIES']['color']['VALUE_XML_ID'] ?? '' ?>">
                                <span><span><?= $item['PROPERTIES']['price']['VALUE'] ?? ''; ?> </span>
                                    <?= $item['PROPERTIES']['price']['DESCRIPTION'] ? number_format($item['PROPERTIES']['price']['DESCRIPTION'], null, null, ' ') : ''; ?><span> ₽</span></span>
              </div>
              ...
              <div class="get-started">
                <a href="<?= $item['DETAIL_PAGE_URL'] ?>"
                   class="btn <?= $item['PROPERTIES']['color']['VALUE_XML_ID'] ?? '' ?>">
                  Узнать больше
                </a>
              </div>
            </div>
